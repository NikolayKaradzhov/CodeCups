...
public class RegistrationServiceImpl {
    ...
    public String register(UserRegistrationRequest userRegistrationRequest) {
        ...
        String token = userServiceImpl.signUpUser(new User(userRegistrationRequest.getFirstName(),
                userRegistrationRequest.getLastName(),
                userRegistrationRequest.getEmail(),
                userRegistrationRequest.getPassword()));

        mailSender.send(userRegistrationRequest.getEmail(),
                buildEmail(userRegistrationRequest.getFirstName(), MailConstant.TOKEN_CONFIRMATION_LINK + token));
